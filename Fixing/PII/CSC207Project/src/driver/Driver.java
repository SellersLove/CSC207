...
import phaseii.ClientManager;
import phaseii.FlightManager;
import phaseii.Itinerary;

/** A Driver used for autotesting the project backend. */
public class Driver {
	public static ClientManager cm = new ClientManager();
	...
	public static String getItinerariesSortedByCost(String date, String origin, String destination) {
		...
		List<Itinerary> temp = fm.sortByCost(fm.getItineraries(date, origin, destination));
